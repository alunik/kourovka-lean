...
public import Kourovka.External.TauCeti.Algebra.Group.Subgroup.Pointwise
public import Kourovka.External.TauCeti.GroupTheory.DoubleCoset.Orbits
public import Kourovka.External.TauCeti.GroupTheory.QuotientGroup.Basic
...
theorem stabilizer_eq_mackeySubgroup_subgroupOf (s : G) (H K : Subgroup G) :
  ...
  rw [Subgroup.mem_subgroupOf, mem_mackeySubgroup_iff]
  change (g : G) ∈ stabilizer G (s : G ⧸ H) ↔ _
