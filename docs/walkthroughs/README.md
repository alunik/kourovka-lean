...
develop and build on. Human acceptance concerns the mathematical source snapshot,
not this subsequently written prose.

The notes were revised on 17 September 2026 to present the mathematical arguments
directly. The original acceptance dates remain 16 September 2026 for the six v0
results and 17 September 2026 for 21.53; the accepted statements, proof sources and
verification records are unchanged. The adjacent metadata records the text
revision separately.
...
| 21.53 | [Two colours do not determine the rest](21.53.md) |
| 21.68 | [A semiabelian group that is not monomial](21.68.md) |
| 21.106 | [Two formula values, an infinite subgroup](21.106.md) |

Each account links formal resources at the accepted proof revision.
